    ...
    <div class="container">
        ...
        <div class="job-details">
            ...
            <div class="apply-button-container">
                <a href="{{ route('user.job.info', $job->id) }}" class="btn btn-apply">応募する</a>
            </div>
        </div>
            ...
            <div class="related-jobs">
                ...
                <ul>
                    @foreach($relatedJobs as $relatedJob)
                        <li><a href="{{ route('user.job.show', $relatedJob->id) }}">{{ $relatedJob->title }}</a></li>
                    @endforeach
                </ul>
            </div>
        @endif

        <a href="{{ route('user.job.list') }}" class="btn btn-primary">求人一覧に戻る</a>
    </div>
</body>
</html>